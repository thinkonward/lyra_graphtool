...
texinfo_documents = [
    (master_doc, 'lyra_graphtool', 'lyra_graphtool Documentation',
     author, 'helloWorld', 'lyra_graphtool package documentation',
     'optimisation'),
]
...
html_context['github_user'] = 'studio-x-llc'
html_context['github_repo'] = 'lyra_graphtool'
